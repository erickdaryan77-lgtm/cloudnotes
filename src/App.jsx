...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-slate-950">
      {/* Sidebar Futurista */}
      <aside className="w-72 bg-slate-900/80 backdrop-blur-xl border-r border-slate-700/50 flex flex-col shadow-2xl">
      ...
      <main className="flex-1 overflow-auto">
        <header className="bg-slate-900/60 backdrop-blur-xl p-6 border-b border-slate-700/50 flex justify-between items-center sticky top-0 z-10">
